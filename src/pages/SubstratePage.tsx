...
import { MuninnSelect, Field, PanelMsg, SqlChip, StatusBadge } from '../components/bench/shared';
          ...
          <Block title={t('bench.sub.failures', 'Failure profile (rule-based v0)')}
            ...
            <div style={{ marginBottom: 8 }}>
              <Field label={t('bench.run', 'Run')}>
                <MuninnSelect value={taxRun} onChange={setTaxRun} allLabel={t('bench.sub.allRuns', 'all runs')}
