...
import type { CaseRow, FactRow, RunRow, SubstrateRow } from '../../utils/benchData';
import { defaultRunId, fmtF1, short, substrateSortKey, winLoss } from '../../utils/benchData';
import { CaseDetails } from './CasesScreen';
import { BenchSelect, Field, PanelMsg, ScreenTitle } from './shared';
  ...
  return (
    <div data-testid="bench-winloss">
      ...
      <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap', marginBottom: 10, alignItems: 'center' }}>
        ...
        <Field label="A"><BenchSelect value={effA} onChange={setSubA} options={subOptions} /></Field>
        <Field label="B"><BenchSelect value={effB} onChange={setSubB} options={subOptions} /></Field>
