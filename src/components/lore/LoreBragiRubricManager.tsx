...
const S: Record<string, React.CSSProperties> = {
  ...
  title: { fontSize: 'var(--fs-xs)', color: 'var(--t3)', textTransform: 'uppercase', letterSpacing: '0.04em' },
  addBtn:{ fontSize: 'var(--fs-sm)', color: 'var(--t2)', background: 'transparent', border: '1px solid var(--b3)',
           borderRadius: 5, padding: '3px 9px', cursor: 'pointer' },
  chips: { display: 'flex', gap: 6, flexWrap: 'wrap', marginTop: 8 },
  chip:  { fontSize: 'var(--fs-sm)', color: 'var(--acc)', background: 'color-mix(in srgb, var(--acc) 14%, transparent)',
           border: '1px solid color-mix(in srgb, var(--acc) 30%, transparent)', borderRadius: 6, padding: '2px 8px' },
  hint:  { fontSize: 'var(--fs-sm)', color: 'var(--t3)' },
  ...
  input: { height: 26, padding: '0 8px', borderRadius: 4, border: '1px solid var(--b3)', background: 'var(--bg0)',
           color: 'var(--t1)', fontSize: 'var(--fs-sm)', fontFamily: 'inherit', outline: 'none', minWidth: 130 },
  saveBtn:{ height: 26, padding: '0 12px', borderRadius: 5, border: 'none', cursor: 'pointer',
            background: 'var(--acc)', color: 'var(--on-accent)', fontSize: 'var(--fs-sm)', fontWeight: 600 },
  err:   { fontSize: 'var(--fs-xs)', color: 'var(--dng)', width: '100%' },
};
