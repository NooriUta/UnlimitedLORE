  ...
  return (
    <div style={S.shell}>
      ...
      <Sec label={t('bragi.publicationEditor.sectionAnnotation', 'Указание')}>
        {readOnly ? (
          <div style={{ fontSize: 'var(--fs-base)', color: annotationMd ? 'var(--t2)' : 'var(--t3)', whiteSpace: 'pre-wrap' }}>{annotationMd || '—'}</div>
        ) : (
          <textarea
          ...
          <div style={S.variantBlock}>
            ...
            {!readOnly && (
              <div style={S.variantExtras}>
                ...
                <textarea
                  style={{ ...S.textarea, minHeight: 32, fontSize: 'var(--fs-sm)' }} value={editVariant.annotationMd ?? ''}
...
const S: Record<string, React.CSSProperties> = {
  shell:    { flex: 1, display: 'flex', flexDirection: 'column', minHeight: 0, fontFamily: 'var(--font)', fontSize: 'var(--fs-base)' },
  ...
  errBanner:{ margin: '0 20px 10px', padding: '6px 10px', borderRadius: 5, fontSize: 'var(--fs-sm)',
  ...
  viewModeBtn:   { height: 28, width: 30, borderRadius: 5, border: '1px solid var(--b3)', background: 'transparent', color: 'var(--t3)', cursor: 'pointer', fontSize: 'var(--fs-md)' },
  viewModeBtnOn: { height: 28, width: 30, borderRadius: 5, border: '1px solid var(--acc)', background: 'color-mix(in srgb, var(--acc) 14%, transparent)', color: 'var(--acc)', cursor: 'pointer', fontSize: 'var(--fs-md)' },
  paneTabs: { display: 'flex', gap: 4, padding: '0 20px', borderTop: '1px solid var(--b3)' },
  paneTab:   { fontSize: 'var(--fs-base)', padding: '8px 14px', border: 'none', borderBottom: '2px solid transparent', background: 'transparent', color: 'var(--t3)', cursor: 'pointer' },
  paneTabOn: { fontSize: 'var(--fs-base)', padding: '8px 14px', border: 'none', borderBottom: '2px solid var(--acc)', background: 'transparent', color: 'var(--acc)', fontWeight: 600, cursor: 'pointer' },
  editVarTabs: { display: 'flex', alignItems: 'center', gap: 4, flexWrap: 'wrap', marginBottom: 8 },
  editVarTab:   { display: 'inline-flex', alignItems: 'center', gap: 5, fontSize: 'var(--fs-sm)', padding: '4px 10px', borderRadius: 6, border: '1px solid var(--b3)', background: 'transparent', color: 'var(--t3)', cursor: 'pointer' },
  editVarTabOn: { display: 'inline-flex', alignItems: 'center', gap: 5, fontSize: 'var(--fs-sm)', padding: '4px 10px', borderRadius: 6, border: '1px solid var(--acc)', background: 'color-mix(in srgb, var(--acc) 12%, transparent)', color: 'var(--acc)', cursor: 'pointer' },
  editVarTabAdd: { fontSize: 'var(--fs-sm)', padding: '4px 10px', borderRadius: 6, border: '1px dashed var(--bd)', background: 'transparent', color: 'var(--t3)', cursor: 'pointer' },
  previewTabs: { display: 'flex', alignItems: 'center', gap: 4, flexWrap: 'wrap', padding: '8px 12px 0' },
  pvTab:     { display: 'inline-flex', alignItems: 'center', gap: 5, fontSize: 'var(--fs-sm)', padding: '4px 9px', borderRadius: '6px 6px 0 0', borderTop: '1px solid var(--b3)', borderLeft: '1px solid var(--b3)', borderRight: '1px solid var(--b3)', borderBottom: 'none', background: 'transparent', color: 'var(--t3)', cursor: 'pointer' },
  pvTabOn:   { display: 'inline-flex', alignItems: 'center', gap: 5, fontSize: 'var(--fs-sm)', padding: '4px 9px', borderRadius: '6px 6px 0 0', borderTop: '1px solid var(--acc)', borderLeft: '1px solid var(--acc)', borderRight: '1px solid var(--acc)', borderBottom: 'none', background: 'color-mix(in srgb, var(--acc) 12%, transparent)', color: 'var(--acc)', cursor: 'pointer' },
  pvDot:     { width: 7, height: 7, borderRadius: '50%', flex: 'none' },
  pvSkinName:{ fontSize: 'var(--fs-xs)', color: 'var(--t2)', textTransform: 'none', letterSpacing: 0, fontFamily: 'var(--mono)' },
  previewHead: { display: 'flex', alignItems: 'center', gap: 5, flexWrap: 'wrap', padding: '8px 12px', borderBottom: '1px solid var(--b3)', fontSize: 'var(--fs-xs)', color: 'var(--t3)', textTransform: 'uppercase', letterSpacing: '0.04em' },
  ...
  skinChip:  { fontSize: 'var(--fs-sm)', padding: '2px 8px', borderRadius: 5, border: '1px solid var(--b3)', background: 'transparent', color: 'var(--t2)', cursor: 'pointer', textTransform: 'none', letterSpacing: 0 },
  skinChipOn:{ fontSize: 'var(--fs-sm)', padding: '2px 8px', borderRadius: 5, border: '1px solid var(--acc)', background: 'color-mix(in srgb, var(--acc) 14%, transparent)', color: 'var(--acc)', cursor: 'pointer', textTransform: 'none', letterSpacing: 0 },
  ...
  coverPlaceholder: { width: 128, height: 90, borderRadius: 8, border: '1px dashed var(--b3)', background: 'var(--b1)',
                      display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 'var(--fs-xs)', color: 'var(--t3)', textAlign: 'center', padding: 6 },
  coverHint: { fontSize: 'var(--fs-xs)', color: 'var(--t3)', marginTop: 4 },
  ...
  readOnlyChip:  { fontSize: 'var(--fs-sm)', color: 'var(--t2)', background: 'var(--b2)', border: '1px solid var(--b3)',
  ...
  sameAsMainLabel: { display: 'flex', alignItems: 'center', gap: 6, fontSize: 'var(--fs-sm)', color: 'var(--t2)', marginBottom: 6, cursor: 'pointer' },
  variantSelect:   { height: 28, borderRadius: 4, border: '1px solid var(--b3)', background: 'var(--b1)',
                     color: 'var(--t1)', fontSize: 'var(--fs-base)', padding: '0 6px', width: 100 },
  variantSelectSm: { height: 28, borderRadius: 4, border: '1px solid var(--b3)', background: 'var(--b1)',
                     color: 'var(--t1)', fontSize: 'var(--fs-base)', padding: '0 6px', width: 90 },
  variantInput:   { height: 28, flex: 1, borderRadius: 4, border: '1px solid var(--b3)', background: 'var(--b1)',
                    color: 'var(--t1)', fontSize: 'var(--fs-base)', padding: '0 8px', outline: 'none' },
  variantInputSm: { height: 28, borderRadius: 4, border: '1px solid var(--b3)', background: 'var(--b1)',
                    color: 'var(--t1)', fontSize: 'var(--fs-base)', padding: '0 6px', width: 140 },
  ...
  addVariantBtn: { marginTop: 4, height: 28, padding: '0 12px', borderRadius: 4, border: '1px dashed var(--bd)',
                   background: 'transparent', color: 'var(--t3)', fontSize: 'var(--fs-base)', cursor: 'pointer' },
  ...
  restoreBanner: { margin: '0 20px 10px', padding: '6px 10px', borderRadius: 5, fontSize: 'var(--fs-sm)',
  ...
  forsetiLabel: { fontSize: 'var(--fs-xs)', color: 'var(--t3)', marginBottom: 4 },
  ...
  todoText: { fontSize: 'var(--fs-base)', color: 'var(--t1)', flex: 1 },
  ...
  variantImgPlaceholder: { width: 64, height: 44, borderRadius: 5, border: '1px dashed var(--b3)', background: 'var(--b1)',
                           display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 'var(--fs-2xs)', color: 'var(--t3)', textAlign: 'center' },
  ...
  utmInput: { height: 26, borderRadius: 4, border: '1px solid var(--b3)', background: 'var(--b1)',
              color: 'var(--t1)', fontSize: 'var(--fs-sm)', padding: '0 7px', width: 110, outline: 'none' },
  campaignUrlRow: { display: 'flex', alignItems: 'center', gap: 6 },
  campaignUrlText: { fontSize: 'var(--fs-xs)', color: 'var(--acc)', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', flex: 1 },
  copyBtnSm: { height: 22, width: 22, borderRadius: 4, border: '1px solid var(--b3)', background: 'transparent',
               color: 'var(--t2)', cursor: 'pointer', fontSize: 'var(--fs-sm)', flexShrink: 0 },
  copyBtn: { height: 22, width: 22, borderRadius: 4, border: '1px solid var(--b3)', background: 'transparent',
             color: 'var(--t2)', cursor: 'pointer', fontSize: 'var(--fs-base)', flexShrink: 0 },

  issuesStrip: { display: 'flex', flexDirection: 'column', gap: 3, padding: '6px 12px', borderBottom: '1px solid var(--b3)' },
  issueWarn: { fontSize: 'var(--fs-xs)', color: 'var(--dng)' },
  issueInfo: { fontSize: 'var(--fs-xs)', color: 'var(--t3)' },

  metricsRow: { display: 'flex', gap: 6, flexWrap: 'wrap' },
  metricChip: { fontSize: 'var(--fs-xs)', padding: '2px 6px', borderRadius: 3, background: 'var(--b2)', color: 'var(--t2)', fontFamily: 'var(--mono)' },
};
